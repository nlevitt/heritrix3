 ...
 * @contributor nlevitt
 */
public class FetchHTTPHttpClient extends FetchHTTPBase implements Lifecycle {

    private static Logger logger = Logger.getLogger(FetchHTTPHttpClient.class.getName());
            ...
            threadHttpClient = new ThreadLocal<RecordingHttpClient>() {
                protected RecordingHttpClient initialValue() {
                    RecordingHttpClient httpClient = new RecordingHttpClient(
                            FetchHTTPHttpClient.this, sslContext(), getServerCache());
