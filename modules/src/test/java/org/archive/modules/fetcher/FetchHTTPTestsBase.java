...
import static org.archive.modules.fetcher.FetchHTTPTestBase.BASIC_AUTH_LOGIN;
import static org.archive.modules.fetcher.FetchHTTPTestBase.BASIC_AUTH_PASSWORD;
import static org.archive.modules.fetcher.FetchHTTPTestBase.BASIC_AUTH_REALM;
import static org.archive.modules.fetcher.FetchHTTPTestBase.DEFAULT_GZIPPED_PAYLOAD;
import static org.archive.modules.fetcher.FetchHTTPTestBase.DEFAULT_PAYLOAD_STRING;
import static org.archive.modules.fetcher.FetchHTTPTestBase.DIGEST_AUTH_LOGIN;
import static org.archive.modules.fetcher.FetchHTTPTestBase.DIGEST_AUTH_PASSWORD;
import static org.archive.modules.fetcher.FetchHTTPTestBase.DIGEST_AUTH_REALM;
import static org.archive.modules.fetcher.FetchHTTPTestBase.ETAG_TEST_VALUE;
...
abstract public class FetchHTTPTestsBase extends ProcessorTestBase {

    private static Logger logger = Logger.getLogger(FetchHTTPTestsBase.class.getName());
    static {
    ...
    protected FetchHTTPBase fetcher;
    
    protected FetchHTTPBase fetcher() throws IOException {
        if (fetcher == null) { 
            fetcher = makeModule();
        }
    ...
    protected void runDefaultChecks(CrawlURI curi, String... exclusionsArray)
        ...
        if (!exclusions.contains("httpBindAddress")) {
            assertEquals("127.0.0.1", FetchHTTPTestBase.getLastRequest().getRemoteAddr());
        }
    ...
    public void tryHttpBindAddress(String addr) throws Exception {
        ...
        assertEquals(addr, FetchHTTPTestBase.getLastRequest().getRemoteAddr());
    ...
    public void testLaxUrlEncoding() throws Exception {
        ...
        // XXX this works... should we just use HttpURLConnection?
        // java.net.URL url = new java.net.URL("http://localhost:7777/99%");
        // assertEquals("http://localhost:7777/99%", url.toString());
    }
    ...
    protected abstract FetchHTTPBase makeModule() throws IOException;
}
