...
public abstract class FetchHTTPTestBase extends TestCase {
...
//    }
    ...
    protected static class FetchHTTPTestSetup extends TestSetup {
        protected FetchHTTPTestSetup(Test test) {
            super(test);
        }
